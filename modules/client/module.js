...
.controller('client.mainController', ['$rootScope', '$scope', 'modalService', 'client.updateService', function($rootScope, $scope, modalService, updateService){
...
.factory('client.updateService', ['$http', '$q', '$state', 'alertService', function($http, $q, $state, alertService){
	var deferred;
	return {
		get: function(editId){
			deferred = $q.defer();
